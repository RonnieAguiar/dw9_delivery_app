...
import 'package:dw9_delivery/app/core/exceptions/unauthorized_exception.dart';
import 'package:dw9_delivery/app/models/auth_model.dart';
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<AuthModel> login(String email, String password) async {
    try {
      final result = await dio.auth().post(
        '/auth',
        data: {
          'email': email,
          'password': password,
