import 'package:dw9_delivery/app/core/extensions/formatter_extension.dart';
...
import 'package:dw9_delivery/app/pages/order/order_controller.dart';
import 'package:dw9_delivery/app/pages/order/widget/order_field.dart';
import 'package:dw9_delivery/app/pages/order/widget/order_product_tile.dart';
import 'package:dw9_delivery/app/pages/order/widget/payment_types_fields.dart';
...
class _OrderPageState extends BaseState<OrderPage, OrderController> {
  ...
  void _showConfirmProductDialog(OrderConfirmDeleteProductState state) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('Deseja exclir ${state.orderProduct.product.name}?'),
          actions: [
            TextButton(
              onPressed: () {
